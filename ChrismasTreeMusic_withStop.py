...
song1 = tk.Button(mainContent, text="Ave Maria", height = 2, width = 14, command = songOne) ## duplicate this with actual songs
song2 = tk.Button(mainContent, text="Away in a Manger", height = 2, width = 14, wraplength = 100, command = songTwo)
song3 = tk.Button(mainContent, text="Carol of the Bells", height = 2, width = 14, command = songThree)
song4 = tk.Button(mainContent, text="Deck the Halls", height = 2, width = 14, command = songFour)
song5 = tk.Button(mainContent, text="God Rest ye Merry Gentlemen", height = 2, width = 14, wraplength = 120, command = songFive)
song6 = tk.Button(mainContent, text="Good King Wenceslas", height = 2, width = 14, wraplength = 100, command = songSix)
song7 = tk.Button(mainContent, text="Hark the Herald Angels Sing", height = 2, width = 14, wraplength = 120, command = songSeven)
song8 = tk.Button(mainContent, text="Have a Happy Christmas", height = 2, width = 14, wraplength = 100, command = songEight)
song9 = tk.Button(mainContent, text="Jingle Bells", height = 2, width = 14, command = songNine)
song10 = tk.Button(mainContent, text="Christmas in L.A.", height = 2, width = 14, wraplength = 100, command = songTen)
song11 = tk.Button(mainContent, text="Oh Come, Oh Come, Emmanuel", height = 2, width = 14, wraplength = 120, command = songEleven)
song12 = tk.Button(mainContent, text="Oh Holy Night", height = 2, width = 14, command = songTwelve)
song13 = tk.Button(mainContent, text="O Tannenbaum", height = 2, width = 14, command = songThirteen)
song14 = tk.Button(mainContent, text="Silent Night", height = 2, width = 14, command = songFourteen)
song15 = tk.Button(mainContent, text="The First Noel", height = 2, width = 14, command = songFifteen)
song16 = tk.Button(mainContent, text="The Holly and the Ivy", height = 2, width = 14, wraplength = 100, command = songSixteen)
song17 = tk.Button(mainContent, text="Twelve Days of Christmas", height = 2, width = 14, wraplength = 100, command = songSeventeen)
song18 = tk.Button(mainContent, text="Up on the Housetop", height = 2, width = 14, wraplength = 100, command = songEighteen)
song19 = tk.Button(mainContent, text="We Three Kings", height = 2, width = 14, command = songNineteen)
song20 = tk.Button(mainContent, text="Wish you... / Joy to the World", height = 2, width = 14, wraplength = 120, command = songTwenty)


stop = tk.Button(mainContent, text="Stop Music", height = 2, width = 7, command = stopMusic) ## duplicate this with actual songs
